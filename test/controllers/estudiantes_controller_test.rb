...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference("Estudiante.count") do
      post estudiantes_url, params: { estudiante: { apellidos: @estudiante.apellidos, carnet: @estudiante.carnet, carrera: @estudiante.carrera, celular: @estudiante.celular, edad: @estudiante.edad, fecha_de_nacimiento: @estudiante.fecha_de_nacimiento, nombre: @estudiante.nombre } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { apellidos: @estudiante.apellidos, carnet: @estudiante.carnet, carrera: @estudiante.carrera, celular: @estudiante.celular, edad: @estudiante.edad, fecha_de_nacimiento: @estudiante.fecha_de_nacimiento, nombre: @estudiante.nombre } }
